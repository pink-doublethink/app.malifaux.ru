...
import PartImagesList from '@/components/molecules/PartPage/PartImagesList'
import { formatPrice } from '@/utils/common'
import { $shoppingCart } from '@/context/shopping-cart'
import CartHoverCheckedSvg from '@/components/atoms/CartHoverCheckedSvg/CartHoverCheckedSvg'
import CartHoverSvg from '@/components/atoms/CartHoverSvg/CartHoverSvg'
import spinnerStyles from '@/styles/spinner/index.module.scss'
import { toggleCartItem } from '@/utils/shopping-cart'
import { $user } from '@/context/user'
import { useMediaQuery } from '@/hooks/useMediaQuery'
import PartTabs from '@/components/molecules/PartPage/PartTabs'
import DashboardSlider from '@/components/molecules/DashboardPage/DashboardSlider'
...
import PartAccordion from '@/components/molecules/PartPage/PartAccordion'
