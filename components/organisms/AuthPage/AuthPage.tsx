...
import SignUpForm from '@/components/molecules/AuthPage/SignUpForm'
import SignInForm from '@/components/molecules/AuthPage/SignInForm'
import styles from '@/styles/auth/index.module.scss'
import ModeToggler from '@/components/atoms/ModeToggler/ModeToggler'
